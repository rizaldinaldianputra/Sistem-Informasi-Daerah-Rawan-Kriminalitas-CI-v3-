...
class Googlemaps
{
	...
	var $apiKey						= 'AIzaSyDxvZ_NiV1NWe4e0uwukrpuUZt0KaQbmO4'; // If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
